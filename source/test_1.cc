...
//char *tpch_dir ="/home/aditya/Desktop/DBI_Project/DB_files/";
char *tpch_dir ="../repo/"; // dir where dbgen tpch files (extension *.tbl) can be found /cise/tmp/dbi_sp11/DATA/10M/
